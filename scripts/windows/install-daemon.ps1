...
Write-Host "To capture chat sessions from Claude, Perplexity, ChatGPT, Gemini, etc. into Mnemostroma,"
Write-Host "you MUST load the Mnemostroma browser extension into your browser."
Write-Host "Read the easy setup guide:"
Write-Host "👉 src/extension/docs/INSTALL.md"
Write-Host ""
