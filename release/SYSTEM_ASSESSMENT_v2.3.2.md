...
> **Assessment note**: v2.3.2 embeds SSE and HTTP MCP adapters inside the daemon process — eliminating two separate processes (~65 MB RAM saved). Port conflict protection added. 926 tests passing.
