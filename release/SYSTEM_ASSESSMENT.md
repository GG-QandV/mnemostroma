...
| **TOTAL BASELINE**              | -                                                 | **~420 MB**  | -           | Optimized for v1.8.4 stabilization                                   |
...
| **Session Window**       | 400 entries      | ~50-100 KB per entry                               |
...
| claude.ai (web)                | SSE + browser ext | Proxy: ~70 MB              | ✓ Stable          |
...
```
┌─ MNEMOSTROMA v1.8.4 RESOURCE MAP ────────────────────────────┐
│                                                                 │
│  Component Footprint:        ~420 MB baseline                 │
│  Model Zoo:                  184 MB (shared ONNX)              │
│  Peak Usage:                 ~650 MB (hard limit)             │
...
**v1.8.4** | Offline-first | 450 tests passing
