...
### Шаг 5. Backups — очистка по правилу

**Правило:**
- Апрель, май, июнь — по 3 бэкапа (около 10-го, 20-го, 30-го числа)
- Июль: 5–7 → 1 бэкап (6-е), 8–10 → 1 (9-е), 18–20 → 1 (19-е), с 21-го — все
...
**Освобождено:** 20 GB → 8.5 GB (**−11.5 GB**)

### Итоговое состояние ~/.mnemostroma

| Метрика | До | После |
|---------|----|-------|
| mnemo.db-wal | 329 MB | ~3 MB (чекпоинтится) |
| logs.db | 96 MB | 96 MB |
| backups | 20 GB (611 файлов) | 8.5 GB (52 файла) |
| total ~/.mnemostroma | ~24 GB | ~12 GB |
